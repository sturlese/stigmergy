...
def _graph_compliance_prompt(
    *,
    ...
    prompt = (
        ...
        "missing anchors in a cited paragraph or section assigned to that updated subject. When several "
        "anchors describe one framework or source enumeration, integrate them into the smallest coherent "
        "explanation or reproduce the natural numbered list. Never create an `Additional Details`, `Required "
        "Terms`, inventory, or one-paragraph-per-anchor appendix; the repair must read as authored knowledge, "
