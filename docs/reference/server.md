...
as does approving a `repair-proposal` — the repair a gardener finding earned, or the deletion a
person proposed ([ADR 039](../decisions/039-governed-repair-loop.md)). One App-authored commit each,
through `review_decide`, below.
